...
data Command
  ...
  | Deploy String (Maybe String) Bool Bool Bool Bool (Maybe Int) -- ^ `deploy <host>`: host, --service, --init, --rollback, --dry-run, --list, --rollback-to GEN (nbk.1/.7)
